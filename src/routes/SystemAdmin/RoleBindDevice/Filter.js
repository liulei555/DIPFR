...
const Filter = ({
  ...
  return (<div style={{ marginBottom: '15px' }} >
    <Form layout="inline" onSubmit={handleSubmit}>
      <FormItem>{getFieldDecorator('deviceName', {initialValue: '',})(<Input placeholder="设备名称" />)}</FormItem>
      <FormItem>{getFieldDecorator('deviceType', {initialValue: '',})(<Select
        showSearch
        style={{ width: 150}}
        placeholder="请选择设备类型"
      >
      ...
      <FormItem>{getFieldDecorator('deviceNumber', {initialValue: '',})(<Input placeholder="设备编码" />)}
      </FormItem>
      <FormItem>
